...
1. What makes a constraint break over another constraint
2. Why if sometimes if no constraints break you can still see that contstraints are not met

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/j3e63KJ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
